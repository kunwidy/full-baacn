...
// Custom bahasa google translate
...
function googleTranslateElementInit() {
    new google.translate.TranslateElement({
        ...
        includedLanguages: 'en,id', // bahasa yang ditampilkan
...
function setLanguage(lang) {    
    var select = document.querySelector("select.goog-te-combo");        
    if (select) {
        select.value = lang;           // pilih bahasa
        select.dispatchEvent(new Event("change")); // trigger translate            
    }
    setTimeout(function() { 
        var select2 = document.querySelector("select.goog-te-combo");
        showLanguage(select2.value);    
    }, 1000);
}

function showLanguage(cau){ 
    if(cau == 'id'){
        $('#flag_icon').html('<img src="assets/images/flag/id.png" alt="indonesia">');
    }else{//default en
        $('#flag_icon').html('<img src="assets/images/flag/usa.png" alt="engriss">');
    };    
}
